...
\begin{titlepage}
    ...
    \begin{minipage}{0.45\textwidth}
        \begin{flushleft} \large
            ...
            \textbf{\textcolor{primaryColor}{Charrafi Ayoub}}
    ...
    \begin{minipage}{0.45\textwidth}
        \begin{flushright} \large
            ...
            \vspace{0.2cm}
            \textbf{\textcolor{primaryColor}{MR.Mawane Jamal}}
        \end{flushright}
    \end{minipage}
...
\begin{figure}[H]
   ...
   \includegraphics[width=0.8\textwidth]{front.png}
    \par\vspace{0.2cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{class.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{sequn.jpeg}
...
\subsection{Backend}
\begin{itemize}
    \item \textbf{Python } : Langage principal.
...
La page d'accueil  présente l'application et offre un mode "Visiteur" pour tester l'analyse sans inscription.

\begin{figure}[H]
    \centering
     \includegraphics[width=0.9\textwidth]{cap1.png}
    
    \vspace{0.5cm}
    
    \includegraphics[width=0.9\textwidth]{cap2.png}
...
La page d'Upload est le cœur de l'application. Elle permet le glisser-déposer de fichiers. Une fois le document envoyé, le backend extrait le texte et le classifie en temps réel.

\begin{figure}[H]
    \centering
      \includegraphics[width=0.8\textwidth]{uploed.png}
    \par\vspace{0.2cm}
    
    \vspace{0.8cm}
    
   \includegraphics[width=0.8\textwidth]{extr.png}
    \par\vspace{0.2cm}
    \caption{Interface d'upload et affichage des résultats de classification}
\end{figure}

\subsection{Gestion des Documents}
La page du Documents liste tous les fichiers sauvegardés par l'utilisateur avec des options de filtrage et de recherche.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{doc.png}
    \caption{Gestionnaire de documents}
\end{figure}

\subsection{Tableau de Bord (Dashboard)}
La page Dashboard offre une vue d'ensemble analytique. Les graphiques montrent la répartition des documents par catégorie et la confiance moyenne du modèle.

\begin{figure}[H]
    \centering
       \includegraphics[width=0.8\textwidth]{dash1.png}
    \par\vspace{0.2cm}
    
    \vspace{0.8cm}
    
   \includegraphics[width=0.8\textwidth]{dash2.png}
    \par
    
     \vspace{0.8cm}
     
    \includegraphics[width=0.8\textwidth]{dash3.png}
    \par\vspace{0.2cm}}
